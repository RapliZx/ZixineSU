...
/**
 * FILE: manager_sign.h
 * Deskripsi: Daftar sidik jari (Signature) Manajer yang diizinkan oleh Kernel.
 * Pastikan SIZE dan HASH sinkron dengan hasil build GitHub Actions.
 */
...
#define EXPECTED_SIZE_ZIXINE 0xa8e9eb
